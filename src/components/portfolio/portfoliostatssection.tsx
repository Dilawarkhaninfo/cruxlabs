...
import { Briefcase, Users, Star, Clock, Award } from "lucide-react";
...
function AnimatedCounter({
  ...
  return (
    <div
      ref={counterRef}
      className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight bg-gradient-to-r from-[#2563eb] to-[#1d4ed8] bg-clip-text text-transparent"
    >
      {count}
  ...
  return (
    <section className="relative py-20 sm:py-28 px-4 sm:px-6 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-10 w-72 h-72 bg-blue-300/15 rounded-full blur-3xl"
      />
      <motion.div
        animate={{
          x: [0, -35, 0],
        ...
        className="absolute bottom-1/4 right-10 w-72 h-72 bg-blue-300/15 rounded-full blur-3xl"
      />

      {/* Grid Pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear_gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]" />
