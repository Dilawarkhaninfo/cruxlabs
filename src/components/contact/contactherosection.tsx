...
export default function ContactHeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50/50">
      ...
      {/* Background Grid Pattern (Same as Home Hero) */}
      <div
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-base leading-relaxed text-muted-foreground sm:text-lg md:text-xl max-w-3xl mx-auto">
            Share your project requirements with us. Whether you’re launching a new
            product, improving an existing system, or scaling operations — our team
            will review your needs and propose a clear, practical solution.
          </p>

          {/* Supporting Line */}
          <p className="mt-6 text-[13px] font-medium text-muted-foreground">
            Clear scope • Honest timelines • Response within 24 hours
          </p>

        </div>
      </div>

      {/* Bottom Gradient Fade (Same as Home Hero) */}
      <div
